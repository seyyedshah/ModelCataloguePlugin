...
modelcatalogue.defaults.relationshiptypes =  [
        ...
        [name: "valueDomain", sourceToDestination: "value domain", destinationToSource: "data elements", sourceClass: DataElement, destinationClass: ValueDomain, sourceToDestinationDescription: "", destinationToSourceDescription: ""],
        [name: "unitOfMeasure", sourceToDestination: "unit of measure", destinationToSource: "value domains", sourceClass: ValueDomain, destinationClass: MeasurementUnit, sourceToDestinationDescription: "", destinationToSourceDescription: ""],
        [name: "dataType", sourceToDestination: "data type", destinationToSource: "value domains", sourceClass: ValueDomain, destinationClass: DataType, sourceToDestinationDescription: "", destinationToSourceDescription: ""],
]
