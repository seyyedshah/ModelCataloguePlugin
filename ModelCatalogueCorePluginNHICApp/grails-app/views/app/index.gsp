            ...
            <div class="navbar-collapse collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li show-for-role="ADMIN" class="dropdown" ui-sref-active="active">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">Data Architect<b class="caret"></b>
                        </a>
                        <ul class="dropdown-menu">
                    ...
                    <li show-for-role="ADMIN" class="dropdown" ui-sref-active="active">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">Administration<b class="caret"></b>
                        </a>
                        <ul class="dropdown-menu">
                ...
                <form show-if-logged-in class="navbar-form navbar-right">
                    <g:link data-placement="bottom" class="btn btn-danger" data-original-title="Logout" rel="tooltip"
                            controller="logout">
